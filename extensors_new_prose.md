...
**Notebook**: [`rewrite/examples/geometry/scenegraph/scenegraph.ipynb`](rewrite/examples/geometry/scenegraph/scenegraph.ipynb)

![Scenegraph 3D scene and 2D sensor photograph](rewrite/plots/scenegraph.png)
...
**Notebook**: [`rewrite/examples/mechanics/modes/modes.ipynb`](rewrite/examples/mechanics/modes/modes.ipynb)

![Baseline vs Coupled Normal Vibration Modes](rewrite/plots/modes.png)
...
**Notebook**: [`rewrite/examples/geometry/multiview/multiview_reconstruction.ipynb`](rewrite/examples/geometry/multiview/multiview_reconstruction.ipynb)

![Multi-view reconstruction, sight cones, splats, and pose covariance](rewrite/plots/multiview_reconstruction.png)
...
**Notebook**: [`rewrite/examples/electromagnetism/constitutive/constitutive.ipynb`](rewrite/examples/electromagnetism/constitutive/constitutive.ipynb)

![Constitutive dispersion, polarization precession, Fresnel surface, and drag](rewrite/plots/constitutive.png)
