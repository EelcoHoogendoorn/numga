...
from numga import Context, NumpyContext
...
_SYNC_NAMES = (
    "ga", "ctx", "mv",
    "Point", "Hyperplane", "Line", "Motor", "Twist", "Camera", "Quadric", "TwistMap", "Scalar",
    "w",
)
...
def bind(algebra: Algebra | Context = PGA2D, context: Context | None = None) -> None:
    ...
    global ga, ctx, mv
    global Point, Hyperplane, Line, Motor, Twist, Camera, Quadric, TwistMap, Scalar
    global w
